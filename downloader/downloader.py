# https://github.com/benshanahan1/nyt_crossword_downloader/tree/master
...
class Puzzle:
    URL_RECENT_PUZZLES = "https://www.nytimes.com/svc/crosswords/v3/36569100/puzzles.json?publish_type=mini&sort_order=asc&sort_by=print_date&date_start={date_start}&date_end={date_end}"
    URL_PUZZLE_BY_ID = (
